...
static const _HapticCmd_type_support_symbol_names_t _HapticCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ecat_msgs, msg, HapticCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ecat_msgs, msg, HapticCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ecat_msgs, msg, HapticCmd)() {
  return &::ecat_msgs::msg::rosidl_typesupport_c::HapticCmd_message_type_support_handle;
}
