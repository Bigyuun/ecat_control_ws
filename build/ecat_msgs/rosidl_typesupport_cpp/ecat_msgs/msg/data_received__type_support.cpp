...
static const _DataReceived_type_support_symbol_names_t _DataReceived_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ecat_msgs, msg, DataReceived)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ecat_msgs, msg, DataReceived)),
  }
};
...
{
  return &::ecat_msgs::msg::rosidl_typesupport_cpp::DataReceived_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ecat_msgs, msg, DataReceived)() {
  return get_message_type_support_handle<ecat_msgs::msg::DataReceived>();
}
